              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-1">
                    ...
                    <FormControl>
                      <Input type="number" min="0" {...field} placeholder="daysToDeliver" />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-1">
                    ...
                    <FormControl>
                      <Input type="number" min="0" step="0.01" {...field} placeholder="shippingPrice" />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-1">
                    ...
                    <FormControl>
                      <Input type="number" min="0" step="0.01" {...field} placeholder="freeShippingMinPrice" />
                    </FormControl>
