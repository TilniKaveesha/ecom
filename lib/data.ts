  ...
  settings: [
    {
      ...
      site: {
        name: 'ecom',
        description:
          'ecom is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
        keywords: 'ecom, Next.js, Tailwind CSS, MongoDB',
        url: 'https://next-mongo-ecommerce-final.vercel.app',
        logo: '/icons/logo.svg',
        slogan: 'Spend less, enjoy more.',
        author: 'Next Ecommerce',
        copyright: '2025, ecom.com, Inc. or its affiliates',
        email: 'admin@example.com',
